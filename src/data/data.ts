  ...
  blogs: [
    {
      ...
      summary:
        "wrong assumptions seem to make up the development world and I wonder why.",
      content: [
    ...
    {
      id: 2,
      slug: "a-technical-comma-1",
      title: "A Technical Comma 2",
      summary: "I'm feeling tired of technology and realising it's downsides.",
      content: ["something"],
      published: false,
    },
  ],
